...
const AboutRoomsy = () => {
    return (
        <div>
             <section className="py-16 px-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        {/* Text Section */}
        <div>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            About <span className="text-primary">Roomsy Nest</span>
          </h2>
          ...
          <Link to='about'>
          <button className="btn btn-primary text-white font-medium py-2 px-5 rounded-full transition">
            Read more
          </button>
          </Link>
        </div>
