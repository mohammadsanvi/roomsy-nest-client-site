...
const FeaturedRoommatePost = () => {
  ...
  useEffect(() => {
    fetch("https://roomsy-nest-server-site.vercel.app/featured-roommates")
      .then((res) => res.json())
      .then((data) => {
        setPosts(data)
        setLoading(false)
  ...
  return (
    <div className="mx-auto px-10 md:px-16 lg:px-20 py-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {posts.map((post, index) => (
            <motion.div
              ...
              className="rounded-2xl shadow-xl dark:bg-gray-800 bg-white p-6 space-y-3 border border-gray-200 dark:border-zinc-700 hover:shadow-2xl transition-all duration-300"
            >
              <div className="flex items-center w-full justify-between">
                ...
                <span
                  className={`text-sm font-semibold px-2 py-0.5 rounded ${post.availability === "Available"
